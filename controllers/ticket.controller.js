...
exports.cantTicketsSinResolverLoc = (req, res) => {
    var condition = [ { $match: { "solucion": { $exists: false } } } , { $group: { _id: "$cliente.ubicacion.localidad.nombre", total: { $sum: 1 } } } ];
...
exports.cantidadTicketsZona1 = (req, res) => {
    var condition = { "cliente.ubicacion.ubicacion_geo": { $geoWithin: { $geometry: { type: "Polygon", coordinates: [ [ 
...
exports.ticketsCombateDeLosPozos = (req, res) => {
    var condition = { $and: [ { $text: { $search: "\"Combate de los Pozos\"" } }, { "cliente.ubicacion.provincia": "CABA" } ] };
...
exports.ultimos3BanfieldLanus = (req, res) => {
    var condition = { $or: [ { "cliente.ubicacion.localidad.nombre": "Banfield" }, { "cliente.ubicacion.localidad.nombre": "Lanús" } ] };
...
exports.todosMenosBanfieldLanus = (req, res) => {
    var condition = { "cliente.ubicacion.localidad.nombre": { $nin: [ "Banfield", "Lanús" ] } };
